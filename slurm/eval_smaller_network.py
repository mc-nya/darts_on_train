import numpy as np
import os,sys
network_type='smaller_network'
script_output_dir=f'scripts/{network_type}/'
config_dir=f'configs/eval_phase/{network_type}/'
...
for root,dir,file_list in os.walk(config_dir):
    for filename in file_list:
        ...
        with open(out_file,mode='w',newline='\n') as script_file:
            ...
            script_file.write(f'#SBATCH --output={save_path}/logs/eval.txt\n')
            ...
            script_file.write(f'python tools/train_net.py --cfg {config_dir}/{filename} OUT_DIR results/{network_type}/{file_prefix}/')
